 ...
 */
package hu.nyme.inga.tipeness.statistics;
...
public class Statistics {
    ...
    public static String getRandomElementFromWeightedElements(HashMap<String, Double> concurrentImmedTransitions)
        ...
        for (String transitionName : concurrentImmedTransitions.keySet()) {
            sumWeight += concurrentImmedTransitions.get(transitionName);
        }
        double random = rnd.nextDouble() * sumWeight;
        double currentVal = 0.0;
        for (String transitionName : concurrentImmedTransitions.keySet()) {
            currentVal += concurrentImmedTransitions.get(transitionName);
